...
### 1. [Deploy Aplikasi Utama & Database](PerpustakaanService/docs/1-setup-kubernetes.md)
Setup MongoDB, RabbitMQ, dan Service Aplikasi (Buku, Anggota, dll).

### 2. [Implementasi Monitoring](PerpustakaanService/docs/2-monitoring.md)
Visualisasi metrik aplikasi menggunakan Prometheus & Grafana.

### 3. [Implementasi Centralized Logging](PerpustakaanService/docs/3-logging.md)
Setup ELK Stack untuk agregasi log dari seluruh container.

### 4. [Implementasi CI/CD dengan Jenkins](PerpustakaanService/docs/4-jenkins-cicd.md)
